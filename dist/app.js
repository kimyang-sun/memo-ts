...
var App = (function () {
    function App(appRoot, popUpRoot) {
        ...
        this.items.addChild(new ImageItem('랜덤 이미지 두번째', 'http://loremflickr.com/560/260'));
        ...
        this.items.addChild(new ImageItem('랜덤 이미지 세번째', 'https://source.unsplash.com/random/560x260'));
